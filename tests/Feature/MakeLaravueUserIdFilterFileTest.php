...
class MakeLaravueUserIdFilterFileTest extends TestCase
{
    /** @test */
    function it_creates_user_id_filter_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Filters/UserId.php";
