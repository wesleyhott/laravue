...
class MakeAbastractFilterFileTest extends TestCase
{
    /** @test */
    function it_creates_a_abstract_filter_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Filters/AbstractFilter.php";
