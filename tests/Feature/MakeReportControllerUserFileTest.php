...
class MakeReportControllerUserFileTest extends TestCase
{
    /** @test */
    function it_creates_a_user_report_controller_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Http/Controllers/Reports/UserReportController.php";
