...
class MakeUserSeederFileTest extends TestCase
{
    /** @test */
    function it_creates_a_user_seeder_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "database/seeders/UserSeeder.php";
