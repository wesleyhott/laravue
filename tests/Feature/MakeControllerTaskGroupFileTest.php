...
class MakeControllerTaskGroupFileTest extends TestCase
{
    /** @test */
    function it_creates_a_task_group_controller_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Http/Controllers/TaskGroupController.php";
