...
class MakeTaskSeederFileTest extends TestCase
{
    /** @test */
    function it_creates_a_task_seeder_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "database/seeders/TaskSeeder.php";
