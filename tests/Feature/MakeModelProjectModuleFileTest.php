...
class MakeModelProjectModuleFileTest extends TestCase
{
    /** @test */
    function it_creates_a_project_module_model_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Models/ProjectModule.php";
