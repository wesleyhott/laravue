...
class MakeLaravueAccessTokenControllerFileTest extends TestCase
{
    /** @test */
    function it_creates_a_laravue_filter_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Http/Controllers/Laravue/AccessTokenController.php";
