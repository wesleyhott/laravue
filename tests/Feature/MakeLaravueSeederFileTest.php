...
class MakeLaravueSeederFileTest extends TestCase
{
    /** @test */
    function it_creates_a_laravue_seeder_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "database/seeders/LaravueSeeder.php";
