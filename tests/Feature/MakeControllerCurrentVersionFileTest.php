...
class MakeControllerCurrentVersionFileTest extends TestCase
{
    /** @test */
    function it_creates_a_current_version_controller_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Http/Controllers/CurrentVersionController.php";
