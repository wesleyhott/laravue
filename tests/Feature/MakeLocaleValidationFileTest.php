...
class MakeLocaleValidationFileTest extends TestCase
{
    /** @test */
    function it_creates_a_locale_validation_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "resources/lang/pt-BR/validation.php";
