...
class MakeModelTaskGroupFileTest extends TestCase
{
    /** @test */
    function it_creates_a_task_group_model_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Models/TaskGroup.php";
