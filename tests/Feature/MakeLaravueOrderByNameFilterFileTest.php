...
class MakeLaravueOrderByNameFilterFileTest extends TestCase
{
    /** @test */
    function it_creates_orderby_name_filter_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Filters/OrderByName.php";
