...
class MakeLocalePaginationFileTest extends TestCase
{
    /** @test */
    function it_creates_a_locale_pagination_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "resources/lang/pt-BR/pagination.php";
