...
class MakeEventMonitorFileTest extends TestCase
{
    /** @test */
    function it_creates_a_monitor_event_file()
    {
        // destination path of the Foo class
        $testClass = str_replace( "tests/Feature", "", __DIR__) . "app/Events/Monitor.php";
