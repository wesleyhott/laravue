...
class MakeFrontModelDetailTest extends TestCase
{
    /** @test */
    function it_creates_a_front_model_index_test()
    {
        ...
        $testClass = str_replace("tests/Unit", "", __DIR__) . "front/src/pages/{$module}/{$model}/forms/{$model}DetailForm.vue";

        // Run the make command
        Artisan::call('laravue:front-model-detail', [
            'model' => $model,
            '--module' => $module,
