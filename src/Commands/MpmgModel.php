...
class MpmgModel extends MpmgCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'mpmg:model {model} {--f|fields=}';
     ...
     * @var string
     */
    protected $description = 'Criação de modelo de negócio nos padrões do MPMG.';
